...
export default function Header() {
  ...
  return (
    <div className="headerbody flex justify-between w-730 mb-10">
      <div className="title">devfinder</div>
      <div className="themeChangeer">
        <div className="flex"><span className="themename">{dark}</span> <span className="moon">{crecentmoon}</span></div>
      </div>
    </div>
  );
}
